 ...
 */
	...
	class TraineesController extends AppController {
		...
		$this->set("scheduleCalendars",$this->ScheduleCalendar->find('all',array('conditions'=>$sccondition,'fields'=>array('ScheduleCalendar.id','ScheduleCalendar.title','ScheduleCalendar.appointment_type','ScheduleCalendar.description','ScheduleCalendar.trainer_id','ScheduleCalendar.trainee_id','ScheduleCalendar.start','ScheduleCalendar.end'))));	
