  ...
  <section class="register-wrapper clearfix">
    ...
    array(
      ...
      'type'=>'checkbox','div' => false
                ...
                <span>Yes I agree to the Personal Training Partners <a href="<?php echo $config['url']?>terms-of-service" target="_blank">Terms of Use and Privacy Policy</a>.</span> </div>
            </div>
