...
/**** FOR 0-5 days left pop up in trial period****/
 ...
 $user_added=date_create($setSpecalistArr['Club']['added_date']);
 $diff=date_diff($today_date,$user_added);
 $date_diff = $diff->format("%R%a");
 $actual_diff = 30 + $date_diff;

if ($actual_diff <= 5 && $actual_diff >= 0 && ($setSpecalistArr['Club']['subscriptionplan'] == "" || $setSpecalistArr['Club']['subscriptionplan'] == NULL))
{
...
if ($actual_diff >= -15 && $actual_diff <= -1 && ($setSpecalistArr['Club']['subscriptionplan'] == "" || $setSpecalistArr['Club']['subscriptionplan'] == NULL))
{
	echo "<script type='text/javascript'>
		function codeAddress() {
...
<section class="contentContainer clearfix">
 ...
 <div style="display:none;float: left; width: 65px;" id="shoCur1"><input type="text" id="customSelectidUsr" class="" name="" style="float: left; width: 60px;"></div>
			...
			<p style="margin:3px 0 3px 0">Hold Down Ctrl Key to select multiple Trainer.</p>
 ...
 <div style="display:none;float: left; width: 65px;" id="shoCur"><input type="text" id="customSelectidUsr2" class="" name="" style="float: left; width: 60px;"></div>
						   ...
						   <p style="margin:3px 0 3px 0">Hold Down Ctrl Key to select multiple Clients/Trainers.</p>
    ...
    text-align: center;">There are only <?php echo $actual_diff; ?> Days left in your trial.</p>
						<br />
                        <a href="http://www.ptpfitpro.com/clubs/index" class="agreelink" style="float:left; margin:18px 0">Purchase Now</a>
						<br />
