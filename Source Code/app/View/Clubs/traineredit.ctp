...
$(document).ready(function(){
	$('#TrainerCertificationOrgId').on('change', function() {
...
$(document).ready(function(){
	$('#TrainerCertificationId').on('change', function() {
  //alert( 'Hello' ); // or $(this).val()
  if(this.value==' ')
  {
   $("#otherhide2").show();	
    ...
    <div class="row">
     <?php echo $this->element('leftclub');?>
      <div class="eight inside-head columns">
        ...
        <div>
        <h2>Edit Trainer</h2>
        <form accept-charset="utf-8" method="post" id="validclubtrainer" class="resform-wrap" enctype="multipart/form-data" controller="clubs" action="/clubs/traineredit/<?php echo base64_encode($trid);?>">
         ...
         <?php }?>   
            ...
            <div class="row">
              <div class="twelve form-select columns">
				...
				echo $this->Form->select('Trainer.certification_org_id',$cert_org1,array('empty'=>'-- Select Certification Organization--','class'=>'sltbx','onchange'=>'document.getElementById(\'customSelectOrgid\').value= this.options[this.selectedIndex].text')); ?>     
			...
			<div class="row">
				<div class="six columns"  id='otherhide' style="display:none;">
					<?php echo $this->Form->text('Trainer.certification_org1', array('maxlength'=>255,'id'=>'Certification Organisation','class'=>'validate[required]','placeholder'=>'Other Certification Organization')); ?>
					
					<?php echo $this->Form->error('Trainer.certification_org1', null, array('class' => 'error')); ?>
                </div>
            </div>
			<!--TEXTBOX HIDE-->
			  ...
			  echo $this->Form->select('Trainer.certification_id',$certifications1,array('empty'=>'-- Select Certification --','class'=>'topAction','onchange'=>'document.getElementById(\'customSelectCrtid\').value= this.options[this.selectedIndex].text')); ?>
			...
			<div class="row">
				<div class="six columns"  id='otherhide2' style="display:none;">
					<?php echo $this->Form->text('Trainer.certification_name1', array('maxlength'=>255,'id'=>'Certification','class'=>'validate[required]','placeholder'=>'Other Certification')); ?>
					
					<?php echo $this->Form->error('Trainer.certification_name1', null, array('class' => 'error')); ?>                             
              </div>
            </div>
           ...
           <?php echo $this->Form->text('Trainer.email', array('maxlength'=>255,'id'=>'EmailAddress', 'class'=>'validate[required,custom[email]]','placeholder'=>'Email Address')); ?>
				...
				<?php echo $this->Form->error('Trainer.email', null, array('class' => 'error')); ?>
				 <?php echo $this->Form->text('Trainer.password', array('maxlength'=>255, 'class'=>'validate[required]','placeholder'=>'Password')); ?>
...
<?php echo $this->Form->text('Trainer.first_name', array('maxlength'=>255,'id'=>'FirstName','class'=>'validate[required]','placeholder'=>'First name')); ?>
            ...
            <div class="row">
              <div class="six columns">
              	<?php echo $this->Form->text('Trainer.phone', array('maxlength'=>255,'id'=>'Phone','placeholder'=>'Phone 555-555-5555','class'=>'validate[required,custom[phone]] text-input','pattern'=>'\d{3}-?\d{3}-?\d{4}')); ?>

				<?php echo $this->Form->error('Trainer.phone', null, array('class' => 'error')); ?>
              </div>
              <div class="six columns">
                <?php echo $this->Form->text('Trainer.mobile', array('maxlength'=>255,'id'=>'Mobile','placeholder'=>'Mobile 555-555-5555','class'=>'validate[required,custom[phone]] text-input','pattern'=>'\d{3}-?\d{3}-?\d{4}')); ?>
		   ...
		   <!--CERTIFICATION PART-->
			 ...
			 <ul class="listing-box">
			  <div id="testDivNested" class="list-scroll-wrap" style="height:auto !important;">
			  <?php 
			  $cnt=1;			 
			  ...
			  ?>
				<li>				  
				  <div class="list-colum second-tabs"><?php echo $full1;  ?></div>
