...
{
	/*var clientid='<?php echo $bclid;?>';*/
	var clientid=$('#TraineeId').val();
	var ScheduleCalendarTimeslot2=$('#ScheduleCalendarTimeslot').val();
	//var ScheduleCalendarTimeslot= getSestime(ScheduleCalendarTimeslot2);
	...
	{
		//alert(ScheduleCalendarTimeslot2);
...
//alert(formatstartdatetime);
//alert(formatenddatetime);
  ...
  <div class="clear"></div>
   ...
   <!-- Change Cover popup -->
                ...
                <div id="evdetail" class="main-popup">
                  <div class="overlaybox common-overlay"></div>
                  <div id="calavppdays" style="position:fixed;" class="register-form-popup common-overlaycontent"> <a class="close-nav" onclick="popupClose('evdetail');" id="pop4" href="javascript:void(0);"></a>
                    <div class="row register-popup-form">
                      <div class="twelve field-pad columns">
				...
				<div id="groupdetail" class="main-popup">
                  <div class="overlaybox common-overlay"></div>
                  <div id="calavppdays" style="position:fixed;" class="register-form-popup common-overlaycontent"> <a class="close-nav" onclick="popupClose('groupdetail');" id="pop4" href="javascript:void(0);"></a>
                    <div class="row register-popup-form">
                      <div class="twelve field-pad columns">
