		...
		<input type="hidden"  name="data[CertificationTrainers][trainer_id]" id="CertificationTrainers_trainer_id" value="<?php echo $setSpecalistArr[$utype]['id'];?>"/>
           ...
           $option=array();
            ...
            $cert_org1 = array_merge($cert_org,$options);
              ...
              echo $this->Form->select('CertificationTrainers.certification_org',$cert_org1,array('empty'=>'Select','class'=>'sltbx','onchange'=>'document.getElementById(\'customSelectOrgid\').value= this.options[this.selectedIndex].text')); ?>          
...
<?php echo $this->Form->text('CertificationTrainers.certification_org1', array('maxlength'=>255,'id'=>'Certification Organisation','class'=>'validate[required]','placeholder'=>'Other Certification Organization')); ?>
...
<?php echo $this->Form->text('CertificationTrainers.certification_name1', array('maxlength'=>255,'id'=>'Certification','class'=>'validate[required]','placeholder'=>'Other Certification')); ?>
			...
			<?php  ?>
            <div class="row">
            <?php echo $this->Form->text('CertificationTrainers.certification_code', array('maxlength'=>255,'id'=>'certification_code', 'class'=>'validate[required]','placeholder'=>'certification number')); ?>

				<?php echo $this->Form->error('CertificationTrainers.certification_code', null, array('class' => 'error')); ?>
           <?php  ?>	
           </div>
			 <div class="row">
