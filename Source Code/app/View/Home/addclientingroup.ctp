    ...
    <div class="row">
     <?php echo $this->element('lefttrainer');?>
      <div class="eight inside-head columns">
        ...
        <?php echo $this->Form->input('GroupMember.group_clients', array('type' => 'select','empty'=>'-- Select Client --','class'=>'sltbx','required'=>'required', 
        'options' => $client_data, 'multiple' => true)); ?>            
