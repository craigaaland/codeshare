...
if(!empty($groupData))
{
		...
		echo '<div style="width:30%;float:left;border:1px solid #e5e5e5;padding:5px; height: 40px;"><b>Client Name</b></div>';
		echo '<div style="width:30%;float:left;border:1px solid #e5e5e5;padding:5px; height: 40px;"><b>Session Type</b></div>';
		echo '<div style="width:40%;float:left;border:1px solid #e5e5e5;padding:5px; height: 40px;"><b>Sessions Purchased / Sessions Used</b></div>';
		foreach($groupData as $groupdetaildata)
		{
			...
			echo '<div style="width:40%;float:left;border:1px solid #e5e5e5;padding:5px">';
